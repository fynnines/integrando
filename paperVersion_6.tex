...
%%%%
% babel (es para cambiar el idioma)
% PLOTS mapas y conglomerados
% bibliografia (paquete natbib)
%%%%
\usepackage{rotating}
...
\renewcommand\spanishtablename{Tabla} % aca cambio el nombre que se le da a las tablas, antes se le decía "cuadro" y ahora le pido que lo llame "tabla"
...
% Date and time: Thu, Aug 02, 2018 - 11:39:03
...
\end{table} 
% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Thu, Aug 02, 2018 - 11:39:08
\begin{table}[!htbp] \centering 
...
\bibliography{reprobib} %aca poner el nombre del archivo
